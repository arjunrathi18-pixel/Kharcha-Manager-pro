    ...
    final theme = dark
        ? ThemeData(
            ...
            appBarTheme: const AppBarTheme(
              ...
              elevation: 0,
              titleTextStyle: TextStyle(color: Colors.white, fontSize: 19, fontWeight: FontWeight.bold, letterSpacing: 0.2),
            ),
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  isSignup ? '$appName mein register karo apna data hamesha ke liye sync rakhne ke liye.' : 'Login karke apna data kisi bhi device par sync kar sakte ho.',
                  textAlign: TextAlign.center,
                ...
                if (isSignup) ...[
                  TextField(
                    ...
                    decoration: _fieldDecoration('Poora Naam'),
                  ),
                  ...
                  TextField(
                    ...
                    readOnly: true,
                    style: const TextStyle(color: Colors.white),
                    decoration: _fieldDecoration('Date of Birth').copyWith(suffixIcon: const Icon(Icons.calendar_today, color: Colors.white54, size: 18)),
                    onTap: () async {
            ...
            DrawerHeader(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(widget.userEmail, style: const TextStyle(fontSize: 13, color: Colors.white70)),
                ],
              ),
            ),
            ListTile(
                          ...
                          child: Center(
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                color: isLeave ? Colors.white : null,
                              ),
                            ),
                          ),
                        ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _row('Total din is mahine', '$daysInMonth'),
                  _row('Leaves (milk nahi aaya)', '$leavesThisMonth'),
                  _row('Milk delivered din', '$deliveredDays'),
                  _row('Total litre', totalLitres.toStringAsFixed(1)),
                  _row('Rate', '\u20b9${widget.pricePerLitre.toStringAsFixed(2)} / litre'),
                  const Divider(height: 24),
                  Container(
                    padding: const EdgeInsets.all(12),
