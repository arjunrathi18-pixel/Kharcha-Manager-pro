...
class DashboardTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final milkAccruedToday = !milkLeaves.containsKey(today) ? milkLitresPerDay * milkPricePerLitre : 0.0;
    final todayDay = now.day;
    ...
    final milkAccruedMonth = (todayDay - leavesTillToday) * milkLitresPerDay * milkPricePerLitre;

    final todayExpense = sum((e) => isExpenseSection(e.section) && e.date == today && e.category != 'milk') + milkAccruedToday;
    final monthExpense = sum((e) => isExpenseSection(e.section) && monthKeyOf(e.date) == thisMonth && e.category != 'milk') + milkAccruedMonth;
    ...
    final bySection = {
      'home': sum((e) => e.section == 'home' && monthKeyOf(e.date) == thisMonth && e.category != 'milk') + milkAccruedMonth,
