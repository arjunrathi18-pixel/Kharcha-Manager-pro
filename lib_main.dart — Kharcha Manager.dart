    ...
    if (section == 'home' && cat.key == 'recharge' && existing == null) {
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (_) {
            return PresenceCalendarScreen(
              title: 'Mobile Recharge Tracker',
              categoryKey: 'recharge',
              instructionText: 'Jis din recharge active tha, us date par tap karo',
              presentLabel: 'Active tha',
              absentLabel: 'Active nahi tha',
              presentDays: widget.rechargePresentDays,
              ratePerDay: widget.rechargeRatePerDay,
              onMarkPresent: widget.onMarkRechargePresent,
              onUnmarkPresent: widget.onUnmarkRechargePresent,
              onUpdateRate: widget.onUpdateRechargeRate,
              onRecordPayment: widget.onAddEntry,
              onAddReminder: widget.onAddReminder,
            );
          },
